...
//        버튼 정의
    ...
    override fun onClick(v: View?) {
        inputID = requireView().findViewById(R.id.id_input)
        inputPW = requireView().findViewById(R.id.pw_input)
        ...
        when (v?.id) {
            R.id.login_bt -> {
                LoginAction.doLogin(requireContext(), inputID, inputPW, authAPI)
            }
            R.id.find_id -> {
