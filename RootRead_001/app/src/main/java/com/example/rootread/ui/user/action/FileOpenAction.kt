...
import com.example.rootread.model.kms.GemerateRequest
import com.example.rootread.network.NetworkClient
import com.example.rootread.repository.KmsRepository
import com.example.rootread.ui.user.activity.ViewerActivity
import com.example.rootread.utils.DoRSAUtils
                ...
                if (downloadedFile != null) {
                    ...
                    doRSAUtils.getKeysAsync { key, iv -> // 🔹 AES Key와 IV를 비동기적으로 가져온 후 실행
                        ...
                        try {
                            ...
                            Log.d("KEYCHECK", "key: ${Base64.getEncoder().encodeToString(key)} / iv: ${Base64.getEncoder().encodeToString(iv)}")
