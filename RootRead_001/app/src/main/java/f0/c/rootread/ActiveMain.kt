...
import f0.c.rootread.utils.SecurityUtils
...
class ActiveMain : AppCompatActivity() {
    ...
    private val updateMenuReceiver = object : BroadcastReceiver() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        LocalBroadcastManager.getInstance(this)
            .registerReceiver(updateMenuReceiver, IntentFilter("UPDATE_NAVIGATION_MENU"))
    }
    ...
    override fun onDestroy() {
        // 리시버 해제
        LocalBroadcastManager.getInstance(this)
            .unregisterReceiver(updateMenuReceiver)
        super.onDestroy()
    }
}
